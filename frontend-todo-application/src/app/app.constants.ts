...
//export const API_URL = 'http://todo-function-app1.azurewebsites.net/api/todos'
export const API_URL = 'https://todo-api-management1.azure-api.net/todo-function-app1/todos'
